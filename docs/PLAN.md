...
| ユニットテスト | 5テストすべて PASSED（2025年12月時点） | `docs/PROGRESS_REPORT.md` |
...
| 3-1d | ドキュメント更新 | `docs/MOZC_INTEGRATION.md` を現行手順に合わせて書き換え |
...
| 4-3c | トラブルシューティング更新 | 実機で起きた問題を `docs/TESTING_GUIDE.md` に反映 |
...
7. Ollama 起動 + 実入力テスト
8. 結果を docs/PROGRESS_REPORT.md に反映
```
