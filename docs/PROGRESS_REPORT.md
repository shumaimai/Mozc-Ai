...
| ファイル | 説明 |
|----------|------|
| `docs/GETTING_STARTED.md` | 環境構築からビルドまでの詳細ガイド |
| `docs/BUILD_GUIDE.md` | ビルド方法と成果物の場所 |
| `docs/TESTING_GUIDE.md` | テスト実行とデバッグ方法 |
| `docs/MOZC_INTEGRATION.md` | Mozcソースコードへの統合手順 |
| `docs/BUILD_ERRORS.md` | エラー履歴と解決策 |
...
### 短期目標
1. **Mozcソースコード統合** - `docs/MOZC_INTEGRATION.md` に従って実施
