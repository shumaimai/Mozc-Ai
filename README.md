...
履歴参照用に残っていますが、v1.0.2のサーバーには登録・リンクされません。
...
成果物は `dist/MozcAI-1.0.2-x64.msi` に生成されます。
...
に収録しています。v1.0.2では公開データ版モデルのみを配布します。
...
- `scripts/package_windows.ps1`: v1.0.2 MSIの再現ビルド
